...
- Signal Cards Canary turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page note counter called Signal Cards Canary. It should have three colored counters, add/reset buttons, localStorage persistence, and a visible window.app smoke bridge.
...
- Record Operations - Signal Cards Canary
- Record Editor - Signal Cards Canary
- Insights - Signal Cards Canary

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Signal Cards Canary
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Signal Cards Canary
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - Signal Cards Canary
